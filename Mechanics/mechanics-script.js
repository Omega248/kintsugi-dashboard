...
async function mechLoad() {
  try {
    ...
    for (let i = 1; i < data.length; i++) {
      ...
      if (!across && !engineCount && !civEngineCount && !totalHarness && !totalAdvKit) continue;
